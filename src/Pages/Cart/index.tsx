...
const Cart: FC = () => {   
	...
	<div className="woocommerce-message" >
        ...
        tabIndex={1} className="button wc-forward">
            Continue shopping</a> { store.products[store.products.length -1].product.libProduit } 
                            ...
                            <td data-title="Shipping">
                                {
                                    shippingCost === 0 ? 
                                    <p>
                                        {/* Set an shipping adress so that we can calculate delivery fees */}
    ...
    {/*                                 
                                    ...
                                    */}  {
                                        countries !== null ? countries.all.map((c:any, index: number) => 
                                            <option style={{ fontSize: "1.5em" }} value={  c.alpha2  }  label={c.name}>
                                                {c.name}</option>)
                                            : <></>
                                        }
                                    </select> 
