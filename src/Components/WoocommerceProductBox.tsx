...
const WoocommerceProductBox: FC<{ product: any }> = ( {product} ) => {
        ...
        return (  
            <>
                ...
                <Link to={'/product/' + product.id} data-quantity="1" className="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="278" data-product_sku="" aria-label="Add &ldquo;ORANGE &amp; VANILLA LUXURIOUS NATURAL BODY LOTION&rdquo; to your cart" rel="nofollow">Add to cart</Link>
            </>
        )
}
